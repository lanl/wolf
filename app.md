# Cerberus / WOLF Application Working Notes
...
Cerberus is a development cousin of the WOLF production application. Much of the code, naming, prompts, and infrastructure still use `WOLF` terminology. The core mental model is:
