...
LANL_AIPORTAL_LLMs = {"llm0": {"host":"https://aiportal-api.aws.lanl.gov",
                      ...
                      "llm2": {"host":"https://aiportal-api.aws.lanl.gov",
                               "port":None,
                               "model":"mada.gemma-4-31B-it",
                               "api_version":"v1",
                               "api_key_var":"MADA_AIPORTAL_API_KEY",
                               "verbose": 2,
                               "capabilities":[] #"capabilities":['structured_output']
                               },
                      "llm3": {"host":"https://aiportal-api.aws.lanl.gov",
                               "port":None,
                               #"model":"anthropic.claude-sonnet-4-5-20250929-v1:0",
                               "model":"mada.NVIDIA-Nemotron-3-Nano-30B-A3B-BF16",
                               "api_version":"v1",
                               "api_key_var":"MADA_AIPORTAL_API_KEY",
                               "verbose": 2,
                               "capabilities":[] #"capabilities":['structured_output']
