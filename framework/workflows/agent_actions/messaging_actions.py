...
class MessagingActionArgs(BaseModel):
    ...
    audio_references: Optional[List[AudioReference]] = Field(default=None, description="List of referenced for all audio files mentioned in 'message'")
    image_references: Optional[List[ImageReference]] = Field(default=None, description="List of referenced for all image files mentioned in 'message'")
    video_references: Optional[List[VideoReference]] = Field(default=None, description="List of referenced for all video files mentioned in 'message'")
    file_references:  Optional[List[FileReference]]  = Field(default=[],description="List of referenced for all non-(audio, video, or image) files mentioned in 'message'")
