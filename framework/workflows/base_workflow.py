...
class BaseWorkflow:
    ...
    def __init__(self,
                 ...
                 wf_rules_file: str|None             = WOLF_PATH / "config/preferences/rules/workflow/basewf.md",
                 wf_agent_behaviour_file: str|None   = WOLF_PATH / "config/preferences/behaviour/workflow/basewf.md",
                 wf_agent_sys_prompt_file: str|None  = WOLF_PATH / "config/preferences/prompts/workflow/basewf_default_assistant_sys_prompt.md",
                 wf_user:str                         = "user",
                 wf_turn                             = None,
                 WF_TAG                              = "BaseWorkflow",
                 WF_VERBOSE: int                     = 0
